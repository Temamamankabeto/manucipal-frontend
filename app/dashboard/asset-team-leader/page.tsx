...
const cards = [
  { title: "Pending Fixed Asset Reviews", value: "Review", icon: Clock3 },
  { title: "Approved Procurements", value: "Approved", icon: CheckCircle2 },
  { title: "Returned Procurements", value: "Returned", icon: RotateCcw },
];

export default function AssetTeamLeaderDashboardPage() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded-2xl border bg-card p-5 shadow-sm md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold tracking-tight md:text-3xl">Asset Team Leader Dashboard</h1>
          <p className="mt-1 text-muted-foreground">Review fixed asset procurement requests and technical specifications.</p>
        </div>
