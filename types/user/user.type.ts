...
export type CreateUserPayload = { name: string; email: string; phone: string; password: string; role: UserRoleName | string; admin_level?: AdminLevel | null; address?: string; office_id?: number | null; sub_city_id?: number | null; woreda_id?: number | null; zone_id?: number | null; signature?: File | null; stamp?: File | null; titer?: File | null };
